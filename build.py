...
def header(lang: str, page: str) -> str:
  ...
  <nav class="nav-shell" aria-label="{escape('التنقل الرئيسي' if lang == 'ar' else 'Navigation principale' if lang == 'fr' else 'Main navigation')}">
    <a class="brand" href="{href(lang, 'home')}" aria-label="TerraHit — {escape(nav['home'])}"><img src="/logo_terrahit_circulaire.png" alt="TerraHit LLC" width="188" height="106"></a>
...
def footer(lang: str) -> str:
  ...
  <div class="footer-main">
    <a class="footer-brand" href="{href(lang, 'home')}"><img src="/logo_terrahit_circulaire.png" alt="TerraHit LLC" width="188" height="106"></a>
...
<body>
  <header class="site-header">
    <div class="nav-shell">
      <a class="brand" id="brand-home" href="/" aria-label="TerraHit — Home"><img src="/logo_terrahit_circulaire.png" alt="TerraHit LLC" width="188" height="106"></a>
